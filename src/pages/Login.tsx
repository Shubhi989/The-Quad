  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background relative overflow-hidden">
      ...
      >
        ...
        >
          <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-primary to-primary/60 flex items-center justify-center shadow-[0_0_40px_hsl(199_89%_48%_/_0.4)]">
        ...
        >
          Campus OS — Your digital campus hub
        </motion.p>
